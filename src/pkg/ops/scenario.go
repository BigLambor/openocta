...
var builtinOpsScenarios = []OpsScenario{
	...
	{
		Key:              ScenarioFlinkHealth,
		DomainKey:        DomainHadoop,
		CapabilityKey:    "health-inspection",
		ObjectType:       HealthObjectJob,
		SkillIDs:         []string{"ops-bch-health"},
		PlatformToolKeys: []string{},
		RequiredSources:  []string{SignalTypeBCHWorkload},
		OptionalSources:  []string{SignalTypeMetrics},
		InputSources:     []string{SignalTypeBCHWorkload, SignalTypeMetrics},
		OutputSchema:     "InspectionReport",
		TriggerTypes:     []string{"manual", "cron", "alert_hook"},
	},
	{
		Key:              ScenarioSparkHealth,
		DomainKey:        DomainHadoop,
		CapabilityKey:    "health-inspection",
		ObjectType:       HealthObjectJob,
		SkillIDs:         []string{"ops-bch-health"},
	...
	{
		Key:              ScenarioYarnHealth,
		DomainKey:        DomainHadoop,
		CapabilityKey:    "capacity-performance",
	...
	{
		Key:              ScenarioGBaseInstanceHealth,
		DomainKey:        DomainGBase,
		CapabilityKey:    "health-inspection",
		ObjectType:       HealthObjectDBInstance,
		SkillIDs:         []string{"ops-gbase-health"},
		PlatformToolKeys: []string{"query_gbase_slow_sql"},
		RequiredSources:  []string{SignalTypeGBaseSQL},
		OptionalSources:  []string{SignalTypeMetrics},
		InputSources:     []string{SignalTypeGBaseSQL, SignalTypeMetrics},
		OutputSchema:     "InspectionReport",
		TriggerTypes:     []string{"manual", "cron", "alert_hook"},
	},
	{
		Key:              ScenarioDataAppsPipelineHealth,
		...
		InputSources:     []string{SignalTypeSchedulerAPI, SignalTypeMetrics, SignalTypeAlerts},
		OutputSchema:     "InspectionReport",
		TriggerTypes:     []string{"manual", "cron", "alert_hook"},
	},
	{
