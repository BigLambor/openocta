...
func NewRegistry(ctx *Context) Registry {
	r := Registry{
		...
		"employee.tasks.list":        EmployeeTasksListHandler,
		"employee.tasks.get":         EmployeeTasksGetHandler,
		"employee.tasks.create":      EmployeeTasksCreateHandler,
		"employee.tasks.update":      EmployeeTasksUpdateHandler,
		"employee.tasks.delete":      EmployeeTasksDeleteHandler,
		"employee.effectiveness.get": EmployeeEffectivenessGetHandler,
