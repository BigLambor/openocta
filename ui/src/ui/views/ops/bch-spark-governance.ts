    ...
    return html`
      <div class="flink-summary-grid">
        <div class="summary-card">
          <div class="summary-lbl">算力消耗总量</div>
          <div class="summary-val info">12,500 <span style="font-size:12px; font-weight:normal; color:var(--text-muted)">Cores</span></div>
        </div>
        <div class="summary-card">
          <div class="summary-lbl">识别浪费资源</div>
          <div class="summary-val critical">4,200 <span style="font-size:12px; font-weight:normal; color:var(--text-muted)">Cores</span></div>
        </div>
        <div class="summary-card">
          <div class="summary-lbl">建议调优作业</div>
          <div class="summary-val warning">${warning + critical} <span style="font-size:12px; font-weight:normal; color:var(--text-muted)">个</span></div>
        </div>
        <div class="summary-card">
          <div class="summary-lbl">预计节省成本</div>
          <div class="summary-val healthy">¥ 8,500 <span style="font-size:12px; font-weight:normal; color:var(--text-muted)">/ 月</span></div>
        </div>
      </div>
