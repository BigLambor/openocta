        ...
        <div class="usage-mosaic-section">
          ...
          <div class="usage-daypart-grid">
            ${stats.weekdayTotals.map((part) => {
              ...
              const bg =
                part.tokens > 0 ? `rgba(var(--accent-rgb), ${0.12 + intensity * 0.6})` : "transparent";
              return html`
        ...
        <div class="usage-mosaic-section">
          ...
          <div class="usage-hour-grid">
            ${stats.hourTotals.map((value, hour) => {
              ...
              const bg = value > 0 ? `rgba(var(--accent-rgb), ${0.08 + intensity * 0.7})` : "transparent";
              const title = `${hour}:00 · ${formatTokens(value)} ${t("usageTokensUnit")}`;
              const border = intensity > 0.7 ? "rgba(var(--accent-rgb), 0.6)" : "rgba(var(--accent-rgb), 0.2)";
        ...
        <div class="row" style="justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 12px;">
          ...
          <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 8px;">
            <div style="display: flex; gap: 8px; align-items: center;">
              <span class="date"><input type="date" .value=${props.startDate} disabled style="padding: 6px 10px; border: 1px solid var(--border); border-radius: 6px; background: var(--bg); color: var(--text-regular); font-size: 13px; opacity: 0.6;" /></span>
              <span style="color: var(--text-muted);">to</span>
              <span class="date"><input type="date" .value=${props.endDate} disabled style="padding: 6px 10px; border: 1px solid var(--border); border-radius: 6px; background: var(--bg); color: var(--text-regular); font-size: 13px; opacity: 0.6;" /></span>
            </div>
          </div>
        </div>
      </section>
